...
extension UIImage {
    ...
    public class func gifWithData(data: NSData) -> UIImage? {
        ...
        guard let source = CGImageSourceCreateWithData(data, nil) else {
            print("MuvaGif: Source for the image does not exist")
            return nil
        }
    ...
    public class func gifWithURL(gifUrl:String) -> UIImage? {
        ...
        guard let bundleURL:NSURL? = NSURL(string: gifUrl)
                ...
                print("MuvaGif: This image named \"\(gifUrl)\" does not exist")
                return nil
        }
        
        // Validate data
        guard let imageData = NSData(contentsOfURL: bundleURL!) else {
            print("MuvaGif: Cannot turn image named \"\(gifUrl)\" into NSData")
            return nil
        }
    ...
    public class func gifWithName(name: String) -> UIImage? {
        ...
        guard let bundleURL = NSBundle.mainBundle()
            .URLForResource(name, withExtension: "gif") else {
                print("MuvaGif: This image named \"\(name)\" does not exist")
                return nil
        }
        
        // Validate data
        guard let imageData = NSData(contentsOfURL: bundleURL) else {
            print("MuvaGif: Cannot turn image named \"\(name)\" into NSData")
            return nil
        }
