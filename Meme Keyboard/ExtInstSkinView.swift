...
extension CustomKeyboardViewController
{
    func showInstSkinView()
    {
        ...
        viewAccess.tag = VIEWINSTSKINTAG
        ...
        let image = UIImage(named: "Skin.png")
        imgView.image = image
        ...
        btnClose.addTarget(self, action: "onCloseInstSkinView:", forControlEvents: .TouchUpInside)
    ...
    func onCloseInstSkinView(sender:UIButton!)
    {
        addedHeight = 0
        changeKeyboardHeight()
        
        view.viewWithTag(VIEWINSTSKINTAG)!.removeFromSuperview()
    }
}
